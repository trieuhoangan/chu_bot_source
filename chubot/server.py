...
class ChatbotServer:
    def __init__(self):
        ...
        presentation_file = 'data/presentation.csv'
        ...
        self.answer_retriever.add_more_data(presentation_file)
    ...
    def predict(self,inmessage):
        ...
        if(len(response)>0):
            ...
            response =""
        #
        # process when meet presentation requirement
        #
        if len(entities) >0:
            for entity in entities:
                if entity["entity"] =="present":
                    ...
                    section_id = -1
                    most_similar_question, response=self.answer_retriever.retrieve_answer(inmessage,7)
                    mp3 = response
