...
class ChuBotBrain():
    ...
    def __init__(self, name, language='vi'):
        ...
        self.common_examples = None
        self.regex_features = None
        self.entity_synonyms = None
    ...
    def load_data(self, datafile, **kwargs):
        ...
        #data fields
        self.common_examples = data['nlu_data']['common_examples']
        self.entity_synonyms = data['nlu_data']['entity_synonyms']
        self.regex_features = data['nlu_data']['regex_features']
        self.lookup_tables = data['nlu_data']['lookup_tables']
    ...
    def sum_len(self,list_word,n):
        i=0
        sum = 0 
        while i<n:
            sum = sum + len(list_word[i])
            i = i+1
        return sum
    ...
    def predict_intent(self, inmessage):
        ...
        inmessage_tokens = [token for token in self.nlp(inmessage)]
    ...
    def create_dataset(self, **kwargs):
        ...
        for example in self.common_examples:
            ...
            entity_offsets = [ (e["start"], e["end"], self.nlp(e["entity"]))
